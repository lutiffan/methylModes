source("/home/lutiffan/peakDetectionScripts/peakPicker.R")
...
fillPeakSummary <- function() {
  for (i in 1:totalRows) { #nrow(betas)) {
    ...
    # Steps 2-4: detect local maxima/minima, filter by spacing, filter by sample %, detect presence of any "gaps"
